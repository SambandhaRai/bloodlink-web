                        ...
                        <div className="mx-auto max-w-md pt-8">
                            ...
                            <form onSubmit={handleSubmit(onSubmit)} className="mt-8 space-y-5">
                                ...
                                <button
                                    ...
                                    className="w-full rounded-xl bg-red-800 py-3 text-sm font-semibold text-white shadow-md shadow-red-800/20 hover:bg-red-600 disabled:cursor-not-allowed disabled:opacity-70"
                                >
